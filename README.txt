###
This scripts is from install  one appx from the web of 
https://store.rg-adguard.net/ appx is a extension  for Microsfot Store
###
...
# Script de poweshell creado por Danny Medina Coronel @demcor_
function menu 
{ 
     param ( 
